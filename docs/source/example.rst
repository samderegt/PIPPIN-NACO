...
.. note::
   A discussion of the input parameters in :file:`config.conf` can be found :ref:`here <./configfile.rst/Configuration file>`.
...
In the :ref:`next section <./usage.rst/Usage instructions>` we will learn how to reduce other NACO polarimetric datasets.
